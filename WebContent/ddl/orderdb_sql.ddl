...
INSERT INTO category(categoryName) VALUES ('Biography'); --1
INSERT INTO category(categoryName) VALUES ('Children''s'); --2
INSERT INTO category(categoryName) VALUES ('Fantasy'); --3
INSERT INTO category(categoryName) VALUES ('Conspiracy'); --4
INSERT INTO category(categoryName) VALUES ('Mystery'); --5
INSERT INTO category(categoryName) VALUES ('Non-Fiction'); --6
...
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('The Man Behind The Falls',1,1,'To behold the splendor of the Sequoia Falls is to gaze upon the greatest beauty that nature has to offer. Or is it? Learn about the fascinating true story of a Sim who succeeded against all odds through the eyes of Mike Jeffress. The story of a Sim who refused to take no for an answer. A Sim that just wouldn''t quit. A Sim that created, and now operates, the world''s grandest man made waterfall.',25.00);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('Famous Spellcasters Throughout History',1,2,'The history of spellcasting is long and extensive. In this four-thousand page volume, every feat completed and spell casted in the last two-hundred-an... Oh, it doesn''t matter, no one is going to read this book.',25.00);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('Chasing The Quadruple Rainbow',2,3,'	A harrowing account of the search for the most dreaded weather phenomenon. More dangerous than tornados, quad-rainbows lure you in with their beauty and then, like unseen ninjas, totally wreck your face. No one knows how they do this... yet.',20.00);
...
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('The Adventures of Pink Ruffles',3,5,'Shamed by the pirate community solely for his name, Pink Ruffles sailed the seas with his trusty crew. Vitamin C infused cotton candy kept the crew free of scurvy and teeth. Follow Pink Ruffles and crew as they search for treasure and ultimately... redemption.',1.00);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('Avoiding The Watchful Eye',4,6,'101 tips on avoiding unwanted snoops and spies.',21.00);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('Why are We Here?',4,6,'The answers to all of life''s greatest mysteries. The true reason you are stuck in this canyon.',30.00);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('A Game of Groans',3,7,'Characters groan as one by one they perish, and with the plethora of viewpoints, interwoven storylines, and plot twists, you too will groan as you try to keep it all straight.',25.00);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('Crisis Barn',5,8,'When humble family man Ira Strauss left the big city to start a farm, he never expected to find a dead French diplomat face-down in the hay. Can Ira''s uncanny nose for detail and way with livestock help catch the killer before the FBI tears his barn apart? First in the epic Ira Strauss mystery series!',3.00);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('Lucas Dark and The Increasingly Unlikely Series of Coincidences',5,9,'	This gripping mystery tells the tale of Lucas Dark, an exceedingly attractive author with nothing left to lose but his mind. Written by future award winner Lucas Dark, this--but wait, that''s the main character''s name too! What a coincidence!',1.50);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('1001 Tricks You Can Teach Your Familiar',6,1,'All the tricks you could possibly teach your familiar. Too bad they are always so stubborn they never actually learn.',21.00);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('Gentleman Corgi: A Memoir',6,10,'Sir Woof is the World''s Most Gentlemanly Corgi, a title bestowed by the Distinguished Canine Society. Never one to slobber or gobble his food, he always looks elegant in his top hat, bow tie, and well-groomed fur.',24.50);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('The 50 Shades On My Windows',7,2,'One is light gray. Another is slate. And there''s a charcoal one. Two others are light black and dark white.',23.25);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('The Impromptu Impromptu',7,3,'Surprise your listeners with the Impromptu Impromptu! This piece is so scattered and lacking in any coherent theme that it takes impromptus to a whole new level. META!',15.50);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('Love In the Time of Sandwiches',8,4,'Tiny Tino and Gina are in love, but Gina bends to pressure and marries another. Devastated, Tiny Tino finds solace in a love affair with sandwiches of all shapes, sizes, and flavors. Many years later, Gina becomes a widow. Can she love Tino again? Especially now when he isn’t so tiny?',1.00);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('Packs and Prejudice',8,5,'Lizo Barknet is perfectly happy running his pack as Alpha leader - his rules, no questions asked. That is until arrogant and haughty Ms. Darcie comes to town. Sparks and fur fly in this delightful comedy as these two young lovers delicately navigate Werewolf society and pack expectations.',35.00);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('Seduction by the Sea',8,11,'The perfect blend of passion and paragraphs.',29.50);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('My Pizza-cat-o Polka',2,7,'This piece was written as an homage to Buchholz''s cat, Fiona. She loved music and swayed her tail to the beat whenever Elena played. Whenever Fiona is misbehaving, Buchholz plays this pizzicato.',9.20);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('Dusk Glow',3,12,'This is the classic that started it all! Supernatural romance at its best! Young Darla must decide between a bad-boy vampire and a nice werewolf boy who is friends with her dad. Guess who she picks!!',25.00);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('Dusk Glow 2: Moonrise',3,12,'How does Darla handle it when her secret-vampire boyfriend suddenly disappears from her life? She doesn''t! She completely shuts down as a person. Read about how she literally sits in a chair and does nothing while months slip by. “A great read for young girls!” says the author.',20.00); --20
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('The Cherry Lip Balm Caper',5,8,'Red lips sink ships, at least in Hergstrom they do. Can Liz Schultz put the lid on this case before the criminal smears the facts?',60.00);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('Beyond Big & Bad: Rethinking Harmful Werewolf Stereotypes',6,13,'	Beyond Big & Bad delves deep into today''s rampant mischaracterization of the Werewolf occult. Even as fantastical entities, the fear and anger Sims place upon these fairy-tale creatures has a negative impact on the psyche of the world''s most beloved animal friend: the dog. B B & B devles deep into why these fears exist and challenges readers to consider that maybe what Sims have been afraid of all along was, in fact, themselves.',20.99);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('Cooking With Motes',6,9,'Add a little extra "kick" to your boring, weekday recipes! Magical motes might not be the healthiest (or the most edible) ingredient, but nothing takes a dish from bland to BLAM like a little magic.',25.00);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('Elegy for a Fallen Piano',6,11,'A challenging piece that requires clean pedaling in order to make this song sound even halfway decent. Otherwise, it will sound like a pile of mush.',39.00);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('Yay, Pork Barrels',7,10,'A collection of delirious poems written by one man after successfully eating a hogshead barrel full of bacon. Not to be mistaken with the political manifesto of the same name.',18.40);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('Seven Course Death',8,12,'A rainy night. An old mansion. A dinner party for the toast of Hergstrom''s upper crust. It was meant to be a night of good food, drinks, and parlor games. But when certain secrets are revealed the party must contend with an uninvited guest--MURDER!',25.00);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('Wands of Desire',8,13,'Julie has always been cold when it comes to showing her feelings, but can a dashing old spellcaster melt her heart? Magic is in the air in the first novel of this forty-three volume romantic series.',14.00);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('Peter Barker''s Homecoming Hijinks',2,1,'	Book 2 in the Peter Barker series. Things take a mischievous turn as Peter Barker returns home. Follow along as he finds out what it''s all about!',21.05);
INSERT product(productName, categoryId, authorId, productDesc, productPrice) VALUES ('Fortune Telling for Goofballs',4,6,'7000 Tips and tricks to truly believe you are an effective fortune teller.',20.00);

INSERT INTO warehouse(warehouseName) VALUES ('Main warehouse');
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (1, 1, 5, 25);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (2, 1, 10, 25);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (3, 1, 3, 20);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (4, 1, 2, 22);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (5, 1, 6, 1);
...
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (8, 1, 0, 25);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (9, 1, 2, 3);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (10, 1, 3, 1.50);
...
DECLARE @orderId int
INSERT INTO ordersummary (customerId, orderDate, totalAmount) VALUES (1, '2019-10-15 10:25:55', 28.50)
SELECT @orderId = @@IDENTITY
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 1, 1, 25)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 5, 2, 1.00)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 10, 1, 1.50);

DECLARE @orderId int
INSERT INTO ordersummary (customerId, orderDate, totalAmount) VALUES (2, '2019-10-16 18:00:00', 5.00)
SELECT @orderId = @@IDENTITY
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 5, 5, 1.00);

-- Order 3 cannot be shipped as do not have enough inventory for item 7
DECLARE @orderId int
INSERT INTO ordersummary (customerId, orderDate, totalAmount) VALUES (3, '2019-10-15 3:30:22', 132)
SELECT @orderId = @@IDENTITY
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 6, 2, 21)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 7, 3, 30);

DECLARE @orderId int
INSERT INTO ordersummary (customerId, orderDate, totalAmount) VALUES (2, '2019-10-17 05:45:11', 346.85)
SELECT @orderId = @@IDENTITY
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 3, 4, 20)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 8, 3, 25)
...
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 29, 4, 20);
...
UPDATE Product SET productImageURL = 'img/3.jpg' WHERE ProductId = 5;
UPDATE Product SET productImageURL = 'img/4.jpg' WHERE ProductId = 6;
UPDATE Product SET productImageURL = 'img/4_2.jpg' WHERE ProductId = 7;
UPDATE Product SET productImageURL = 'img/3.jpg' WHERE ProductId = 8;
UPDATE Product SET productImageURL = 'img/2_2.jpg' WHERE ProductId = 9;
UPDATE Product SET productImageURL = 'img/2_2.jpg' WHERE ProductId = 10;
UPDATE Product SET productImageURL = 'img/6.jpg' WHERE ProductId = 11;
UPDATE Product SET productImageURL = 'img/6_2.jpg' WHERE ProductId = 12;
UPDATE Product SET productImageURL = 'img/7.jpg' WHERE ProductId = 13;
UPDATE Product SET productImageURL = 'img/7.jpg' WHERE ProductId = 14;
UPDATE Product SET productImageURL = 'img/8.jpg' WHERE ProductId = 15;
UPDATE Product SET productImageURL = 'img/8_2.jpg' WHERE ProductId = 16;
UPDATE Product SET productImageURL = 'img/8_3.jpg' WHERE ProductId = 17;
UPDATE Product SET productImageURL = 'img/2.jpg' WHERE ProductId = 18;
...
UPDATE Product SET productImageURL = 'img/2_3.jpg' WHERE ProductId = 28;
UPDATE Product SET productImageURL = 'img/3_3.jpg' WHERE ProductId = 29;
