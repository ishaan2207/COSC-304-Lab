...
try {
	...
	while(r.next()){
		...
		out.println("<tr><td><a href = addcart.jsp?id=" + productId + "&name=" + productName1 + "&price=" + productPrice +"> Add to Cart </a>"
		+ productName + "</td><td>" + currFormat.format(productPrice) + "</td></tr>");
